...
/**
 * @author: wangqp
 * @create: 2020-10-14 11:01
 */
public class SequenceMQ {
...
//    消费时，同一个OrderId获取到的肯定是同一个队列。
    ...
    public void syncSend() throws MQClientException, RemotingException, InterruptedException, MQBrokerException {
        ...
        // 订单列表
        List<OrderStep> orderList = new SequenceMQ().buildOrders();
        ...
        for (int i = 0; i < 10; i++) {
            ...
            SendResult sendResult = producer.send(msg, new MessageQueueSelector() {
                ...
                public MessageQueue select(List<MessageQueue> mqs, Message msg, Object arg) {
                    Long id = (Long) arg;  //根据订单id选择发送queue  arg == orderList.get(i).getOrderId() 订单id
